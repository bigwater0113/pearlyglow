...
public class StockController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		ArrayList<ItemsVo> list = dao.selectAll(startItemNum, endItemNum);
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		startItemNum = (page * 10) - 9;
		endItemNum = startItemNum + 9;
		maxPageNum = (int) Math.ceil(dao.getSearchMaxNum(searchCategory, searchGender, searchColor, searchMaterial,
				searchStock, searchText, startItemNum, endItemNum) / 10.0);
		startPageNum = (page - 1) / 10 * 10 + 1;
		endPageNum = startPageNum + 9;
		if (endPageNum > maxPageNum) {
			endPageNum = maxPageNum;
