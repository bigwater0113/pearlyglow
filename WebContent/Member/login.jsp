...
<form method="post" action="${pageContext.request.contextPath}/Member/login">
	...
	<input type="button" value="아이디찾기" onclick="location.href='${pageContext.request.contextPath}/Member/idsearch.html'">
	<input type="button" value="비밀번호찾기" onclick="location.href='${pageContext.request.contextPath}/Member/pwdsearch.html'">
</form>
</body>
</html>
